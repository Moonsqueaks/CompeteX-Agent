...
5. 通过过程追踪页展示多 Agent 协作过程，支撑比赛答辩。
...
6. 前端可以展示输入页、产品画像页、竞争图谱页、报告页、过程追踪页。
...
| 竞争图谱页 | 展示动态竞争关系，是主展示页 | 竞争关系图、切片拨盘、决策链、评分解释、证据卡片、QA 记录 |
| 报告页 | 展示最终分析报告 | 摘要、产品画像、竞品发现、动态切片、用户研究、建议、证据索引 |
| 过程追踪页 | 展示多 Agent 协作过程 | DAG 状态、Agent 输入输出、工具调用、Token、QA 打回前后对比 |
...
6. Prompt 展示到过程追踪页前需要脱敏，隐藏 API Key、用户隐私和过长原文。
...
| A8 | 过程追踪页展示 DAG、工具调用、Token、打回记录 |
