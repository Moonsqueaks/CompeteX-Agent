...
```mermaid
flowchart LR
    Workbench["🖥️ 前端工作台<br/>任务 · 总览 · 画像 · 图谱 · 报告 · 证据追踪"]
    ...
    Assets["🗄️ 数据与产物<br/>SQLite · 领域快照 · 商品 / 产品图片 · Markdown / DOCX / 图谱"]
...
| 🗺️ 竞争图谱 | 关键竞品卡片、商品 / 产品主图、切片解释、证据卡片 |
...
| 🕸️ 竞争格局 | 把关系压缩成战场地图 | 按价格带、人群、场景解释谁对目标产品构成压力 |
...
| 🛡️ 风险与证据边界 | 防止过度断言 | 区分可采纳结论、推断结论、暂无可靠数据和建议复核项 |
